...
add_icon_not_via_filesystem({
    ...
    open: function() {
        Task(make_iframe_window({
            src: "/games/html/3Dchess/",
            icons: iconsAtTwoSizes("3d-chess"),
            title: "3D Chess",
            outerWidth: 835,
            outerHeight: 500,
            resizable: true,
...
add_icon_not_via_filesystem({
    ...
    open: function() {
        Task(make_iframe_window({
            src: "/games/html/HexGL/",
            icons: iconsAtTwoSizes("hexgl"),
            title: "HexGL",
            outerWidth: 835,
            outerHeight: 600,
            resizable: true,
...
add_icon_not_via_filesystem({
    ...
    open: function() {
        Task(make_iframe_window({
            src: "/games/html/hl/",
            icons: iconsAtTwoSizes("half-life"),
            title: "Half-Life",
            outerWidth: 835,
            outerHeight: 600,
            resizable: true,
...
add_icon_not_via_filesystem({
    title: "Minecraft JS Edition",
    iconID: "minecraft",
    open: function() {
        Task(make_iframe_window({
            src: "/games/html/minecraftjs/",
            icons: iconsAtTwoSizes("minecraft"),
            title: "Minecraft JS Edition",
            outerWidth: 835,
            outerHeight: 600,
